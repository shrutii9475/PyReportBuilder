...
def connect_database():
    ...
    if emailEntry.get()=='' or usernameEntry.get()=='' or passwordEntry.get()=='' or confirmpasswordEntry.get()=='' :
        ...
        try:
            ...
            messagebox.showerror('Error','Database connectivity issue. Plz try again!')
            return
...
signupButton = Button(frame, text='Sign UP', font=('Open Sans', 16, 'bold'), 
    bd=0, bg='#FFA3AC', fg='white', activebackground='#00043C', activeforeground='#FFA3AC', width=19, command=connect_database)
...
# #
# tnc = Checkbutton(frame, text='I agree to the Terms and Conditions', font=(
#     'Microsoft Yahei UI Light', 8, 'bold'), bg='white', fg='#00043C', activebackground='white', activeforeground='#00043C')
# tnc.grid(row=9, column=0, sticky='w', padx=10, pady=15)

# #
# signupButton = Button(frame, text='Sign UP', font=('Open Sans', 16, 'bold'), 
#     bd=0, bg='#FFA3AC', fg='white', activebackground='#00043C', activeforeground='#FFA3AC', width=19)
# signupButton.grid(row=10, column=0)
